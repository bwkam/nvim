...
local mappings = {
	...
	x = {
		...
		w = { "<cmd>lua require('trouble').toggle('workspace_diagnostics')<CR>", "Workspace" },
		d = { "<cmd>lua require('trouble').toggle('document_diagnostics')<CR>", "Document" },
	...
	l = {
		...
		c = { "<cmd>lua vim.diagnostic.open_float()<cr>", "Open Diagnostic" },
	...
	f = {
		...
		g = { "<cmd>Telescope git_commits<cr>", "Find commits" },
